...
SUPER_VERY_BOT_TOKEN = os.getenv("7907084038:AAHA8iqSQruAIcv4_H1bgI8-CF6WNb2ZbwA")
ADMIN_BOT_TOKEN = os.getenv("8364703122:AAGZlvIEnrdIo7MssInfKzQRrW75Yi5HQnw")
ADMIN_CHAT_ID = os.getenv("6159408312")
UPI_ID = os.getenv("7053213575@kotak811")
QR_CODE_URL = os.getenv("https://github.com/tnnygoku1221/QR-CODE/blob/main/WhatsApp%20Image%202025-09-06%20at%2017.29.11_5a791fa2.jpg")

# Validate critical variables
if not SUPER_VERY_BOT_TOKEN:
    raise ValueError("❌ SUPER_VERY_BOT_TOKEN is missing. Set it in your environment variables.")
if not ADMIN_CHAT_ID:
    raise ValueError("❌ ADMIN_CHAT_ID is missing. Set it in your environment variables.")
...
async def button_click(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == "meta_verification":
        ...
        keyboard = [
            [InlineKeyboardButton("Standard (₹80)", callback_data="standard")],
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        await query.edit_message_text(
            "Select a plan:",
...
async def handle_message(update: Update, context: CallbackContext) -> None:
    ...
    if user_data.get(user_id, {}).get("awaiting_payment_proof"):
        try:
            ...
            await update.message.reply_text(
                "✅ Payment details received! Admin will proceed with your request.\n\n"
                "For any query and support, contact @support or WhatsApp.",
            )
...
def main() -> None:
    ...
    try:
        if not SUPER_VERY_BOT_TOKEN:
            raise InvalidToken("❌ SUPER_VERY_BOT_TOKEN is missing or invalid. Get it from @BotFather.")
